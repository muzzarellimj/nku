...
$riders = $riderController->readAll();

$driverController = new DriverController();
$drivers = $driverController->readAll();

$rideController = new RideController();
$rides = $rideController->readAll();
...
<head>
    <title>
        <?= $conf['application']['name'] ?> | Administrative Panel
    </title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Administrative Dashboard</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="/foober/public/index.php">Home</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="/foober/public/admin/admin.php">Administrative Dashboard</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section class="section">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-12">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">Riders</p>
                    </div>
                </div>
            </div>
            ...
            <table class="table text-black">
                ...
                <tbody>
                    <?php foreach ($riders as $rider) {
                        $phoneNumber = isset($rider['phonenumber']) ? $rider['phonenumber'] : 'N/A'; ?>
                        ...
                        <tr>
                            ...
                            <td><?= $rider['role'] ?></td>
                            <td><?= $rider['rating'] ?></td>
                            <td><a class="fw-bold" href="/foober/public/admin/delete-rider.php?riderId=<?= $rider['ID'] ?>">Delete</a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
            ...
            <div class="row justify-content-center align-items-center pt-5">
                <div class="col-12">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">Drivers</p>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    <?php foreach ($drivers as $driver) { ?>
                        <tr>
                            ...
                            <td><?= $driver['riderid'] ?></td>
                            <td><?= $driver['licensenumber'] ?></td>
                            <td><?= $driver['licenseexpiration'] ?></td>
                            <td><a class="fw-bold" href="/foober/public/admin/delete-driver.php?driverId=<?= $driver['ID'] ?>">Delete</a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
            ...
            <div class="row justify-content-center align-items-center pt-5">
                <div class="col-12">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">Rides</p>
                    </div>
                </div>
            </div>
            ...
            <table class="table text-black">
                ...
                <tbody>
                    <?php foreach ($rides as $ride) { 
                        $driverId = isset($ride['driverid']) ? $ride['driverid'] : 'N/A'; ?>
                        <tr>
                            <th scope="row"><?= $ride['ID'] ?></th>
                            <td><?= $ride['originid'] ?></td>
                            <td><?= $ride['destinationid'] ?></td>
                            <td><?= $ride['riderid'] ?></td>
                            <td><?= $driverId ?></td>
                            <td><?= $ride['mileage'] ?></td>
                            <td><?= $ride['cost'] ?></td>
                            <td><a class="fw-bold" href="/foober/public/admin/delete-ride.php?rideId=<?= $ride['ID'] ?>">Delete</a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
