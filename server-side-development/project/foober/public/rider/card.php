...
require_once(__DIR__ . '/../../src/database/model/CreditCardModel.php');
...
if ($_SESSION['role'] < RoleAttr::RIDER->valueOf()) {
    header('location: /foober/public/index.php');
}
...
if (count($_POST) > 0) {
    ...
    $createResult = $creditCardController->create(
        new CreditCardModel($riderId, $cardNumber, $cardExpiration, $cardCvv, $cardholderName));

    if (!$createResult) {
        $_SESSION['errorMessage'] = 'We could not register your credit card. Please try again.';
        header('location: /foober/public/rider/card.php');
    }
...
<head>
    <title>
        <?= $conf['application']['name'] ?> | Add a Credit Card
    </title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Add a Credit Card</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="/foober/public/index.php">Home</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="/foober/public/rider/card.php">Add a Credit Card</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">Add a Credit Card</p>
                        <h1>Authorize a payment method</h1>
                                ...
                                <div class="contact-form">
                                    <form method="POST">
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input type="text" class="form-control shadow-none" name="cardNumber" required>
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="cardExpiration" class="form-label">Expiration - MMYY</label>
                                            <input type="text" class="form-control shadow-none" name="cardExpiration" required>
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="cardCvv" class="form-label">CVV</label>
                                            <input type="password" class="form-control shadow-none" name="cardCvv" required>
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="cardholderName" class="form-label">Cardholder Name</label>
                                            <input type="text" class="form-control shadow-none" name="cardholderName"
                                                required>
                                        </div>
