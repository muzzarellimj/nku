...
$creditCards = $creditCardController->readSome(new KVPair('riderid', $_SESSION['riderId']));

if (isset($_SESSION['driverId']) && $_SESSION['role'] >= RoleAttr::DRIVER->valueOf()) {
    $rideController = new RideController();
    $rides = $rideController->readSome(new KVPair('driverid', null));
    $ridesResponsible = $rideController->readSome(new KVPair('driverid', $_SESSION['driverId']));

    if (isset($_SESSION['carId'])) {
        $carController = new CarController();
        $car = $carController->read(new KVPair('ID', $_SESSION['carId']));
    }
}
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3">Hey there, <?= $_SESSION['firstName'] ?>.</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="/foober/public/index.php">Home</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="/foober/public/account.php">Account</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section class="section teams">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">rider dashboard</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-12">
                    <div class="section-title text-center">
                        <h1>Here are your credit cards we have on file.</h1>
                ...
                <?php for ($i = 0; $i < count($creditCards); $i++) {
                    $card = $creditCards[$i];
                ?>
                <div class="icon-box-item col-md-3">
                    <div class="block bg-white">
                        <div class="icon rounded-number">
                            <?= $i + 1 ?>
                        </div>
                        <h3 class="mb-3">
                            <?= $card['cardnumber'] ?>
                ...
                <div class="icon-box-item col-md-3">
                    <div class="block bg-white">
                        <a href="/foober/public/rider/card.php" class="btn btn-primary w-100 mb-0">Add a Card</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center pt-5">
                ...
                <div class="icon-box-item col-md-3">
                    <div class="block bg-white">
                        <a href="/foober/public/auth/driver.php" class="btn btn-primary w-100 mb-0">Become a Driver</a>
                    </div>
                </div>
            </div>
            <?php } ?>
    ...
    <?php if (isset($_SESSION['driverId']) && $_SESSION['role'] >= RoleAttr::DRIVER->valueOf()) { ?>
    <section class="section teams">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">driver dashboard</p>
                    </div>
                </div>

                <?php if (!isset($_SESSION['carId'])) { ?>
                    <div class="col-12">
                        <div class="section-title text-center">
                            <h1>We need you to add a car.</h1>
                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing . egestas
                                <br>cursus pellentesque dignissim dui, congue. Vel etiam ut
                            </p>
                        </div>
                    ...
                    <div class="icon-box-item col-md-3">
                        <div class="block bg-white">
                            <a href="/foober/public/car/add.php"
                                class="btn btn-primary w-100 mb-0">Add a Car</a>
                        </div>
                    </div>
                <?php } ?>

                <?php if (count($ridesResponsible) > 0) { ?>

                    <div class="col-12 pt-5">
                        <div class="section-title text-center">
                            <h1>Here are the rides you've accepted.</h1>
                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing . egestas
                                <br>cursus pellentesque dignissim dui, congue. Vel etiam ut
                            </p>
                        </div>
                    ...
                    <?php for ($i = 0; $i < count($ridesResponsible); $i++) {
                    $ride = $ridesResponsible[$i];
                    $origin = $locationController->read(new KVPair('ID', $ride['originid']));
                    $destination = $locationController->read(new KVPair('ID', $ride['destinationid']))
                        ?>
                    <div class="icon-box-item col-md-3">
                        <div class="block bg-white">
                            <div class="icon rounded-number">
                            ...
                            <h3 class="mb-3">To <?= $destination['city'] ?>, <?= $destination['state'] ?>
                            </h3>
                            <p class="mb-3">
                                <span class="text-primary fw-bold">$<?= substr_replace( $ride['cost'], '.',
                                        strlen($ride['cost']) - 2, 0 ) ?></span> &nbsp; <?= substr_replace(
                                    $ride['mileage'], '.', strlen($ride['mileage']) - 1, 0 ) ?> miles from <br><span
                                        class="fw-bold">
                                        <?= $origin['city'] ?>, <?= $origin['state'] ?>
                                    </span> to <br><span class="fw-bold">
                                        <?= $destination['city'] ?>, <?= $destination['state'] ?>
                                    </span>
                            </p>

                            <a href="/foober/public/ride/complete.php?rideId=<?= $ride['ID'] ?>"
                                class="btn btn-primary w-100 mb-0">Complete</a>
                        </div>
                    </div>
                    <?php }
                } ?>
                ...
                <div class="row justify-content-center pt-5">
                    <div class="col-12">
                        <div class="section-title text-center">
                            <h1>Here are some available rides.</h1>
                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing . egestas
                                <br>cursus pellentesque dignissim dui, congue. Vel etiam ut
                            </p>
                        </div>
                    </div>
                    <?php for ($i = 0; $i < count($rides); $i++) {
            $ride = $rides[$i];
            $origin = $locationController->read(new KVPair('ID', $ride['originid']));
            $destination = $locationController->read(new KVPair('ID', $ride['destinationid']))
                    ?>
                    <div class="icon-box-item col-md-3">
                        <div class="block bg-white">
                            ...
                            <a href="/foober/public/ride/accept.php?rideId=<?= $ride['ID'] ?>"
                                class="btn btn-outline-primary w-100 mb-0">Accept</a>
                        </div>
                    </div>
                    <?php } ?>
                </div>
    ...
    <?php if (isset($_SESSION['riderId']) && $_SESSION['role'] >= RoleAttr::ADMINISTRATOR->valueOf()) { ?>
    <section class="section teams">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">administrative dashboard</p>
                    </div>
                </div>
    
                <div class="col-12">
                    <div class="section-title text-center">
                        <h1>Take a look at some adminstrative tasks.</h1>
                        <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing . egestas
                            <br>cursus pellentesque dignissim dui, congue. Vel etiam ut
                        </p>
                    </div>
                ...
                <div class="icon-box-item col-md-3">
                    <div class="block bg-white">
                        <a href="/foober/public/admin/admin.php" class="btn btn-primary w-100 mb-0">Visit Dashboard</a>
                    </div>
                </div>
            </div>
    </section>
