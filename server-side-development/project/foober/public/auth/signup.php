...
if (count($_POST) > 0) {
    ...
    $result = $controller->create(new RiderModel($emailAddress, $password, $firstName, $lastName));

    if ($result) {
        header('location: /foober/public/auth/signin.php');
    }
}
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Sign Up</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="/foober/public/index.php">Home</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="/foober/public/auth/signup.php">Sign Up</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">Sign up</p>
                                ...
                                <div class="contact-form">
                                    <form method="POST">
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input type="email" class="form-control shadow-none" name="emailAddress" required>
                                        </div>
