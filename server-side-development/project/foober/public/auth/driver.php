...
require_once(__DIR__ . '/../../src/database/model/DriverModel.php');
...
if (count($_POST) > 0) {
    ...
    $insertDriverResult = $driverController->create(
        new DriverModel($riderId, $licenseNumber, $licenseExpiration, $bankAccountNumber, $bankRoutingNumber));

    if (!$insertDriverResult) {
        $_SESSION['errorMessage'] = 'We could not register you as a driver. Please try again.';
        header('location: /foober/public/account.php');
    }

    $updateRiderResult = $riderController->update(new KVPair('ID', $riderId), new KVPair('role', RoleAttr::DRIVER->valueOf()));

    if (!$updateRiderResult) {
        $_SESSION['errorMessage'] = 'We could not register you as a driver. Please try again.';
        header('location: /foober/public/account.php');
    }
...
<head>
    <title>
        <?= $conf['application']['name'] ?> | Become a Driver
    </title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Become a driver</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="/foober/public/index.php">Home</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="/foober/public/auth/driver.php">Become a Driver</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">Become a Driver</p>
                                ...
                                <div class="contact-form">
                                    <form method="POST">
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input type="text" class="form-control shadow-none" name="licenseNumber"
                                                required>
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="licenseExpiration" class="form-label">License Expiration - MMYY</label>
                                            <input type="text" class="form-control shadow-none" name="licenseExpiration"
                                                required>
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="bankAccountNumber" class="form-label">Bank Account Number</label>
                                            <input type="text" class="form-control shadow-none" name="bankAccountNumber"
                                                required>
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="bankRoutingNumber" class="form-label">Bank Routing Number</label>
                                            <input type="text" class="form-control shadow-none" name="bankRoutingNumber"
                                                required>
                                        </div>
