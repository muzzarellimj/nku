...
require_once(__DIR__ . '/../../src/controller/CreditCardController.php');
...
require_once(__DIR__ . '/../../src/database/model/LocationModel.php');
require_once(__DIR__ . '/../../src/database/model/RideModel.php');
...
if (count($_POST) > 0) {
    ...
    $locationController->create(
        new LocationModel(
            $_POST['originStreetAddress1'], $_POST['originStreetAddress2'], 
            $_POST['originCity'], $_POST['originState'], $_POST['originZipCode']));

    $originId = $connection->lastInsertId();

    $locationController->create(
        new LocationModel(
            $_POST['destinationStreetAddress1'], $_POST['destinationStreetAddress2'],
            $_POST['destinationCity'], $_POST['destinationState'], $_POST['destinationZipCode']
        )
    );

    $destinationId = $connection->lastInsertId();
    $riderId = $_SESSION['riderId'];
    $paymentMethod = $_POST['paymentMethod'];
    $mileage = rand(100, 600);
    $cost = rand(1000, 5000);

    $rideController->create(new RideModel($originId, $destinationId, $riderId, $mileage, $cost));

    header('location: /foober/public/account.php');
}

$cardController = new CreditCardController();
$creditCards = $cardController->readSome(new KVPair('riderid', $_SESSION['riderId']));
...
<head>
    <title>
        <?= $conf['application']['name'] ?> | Request a Ride
    </title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Request a Ride</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="/foober/public/index.php">Home</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="/foober/public/ride/request.php">Request a
                                Ride</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">request a ride</p>
                        <h1>Start requesting rides now.</h1>
                        <p>The app is available in thousands of cities worldwide, so you can request a ride even when
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="contact-form">
                                    <form method="POST">
                                        <p class="text-primary text-uppercase fw-bold mb-3">where from?</p>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="originStreetAddress1" class="form-label">Street Address 1</label>
                                            <input type="text" class="form-control shadow-none" name="originStreetAddress1"
                                                required>
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="originStreetAddress2" class="form-label">Street Address 2</label>
                                            <input type="text" class="form-control shadow-none" name="originStreetAddress2">
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="originCity" class="form-label">City</label>
                                            <input type="text" class="form-control shadow-none" name="originCity" required>
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="originState" class="form-label">State</label>
                                            <input type="text" class="form-control shadow-none" name="originState" required>
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="originZipCode" class="form-label">Zip Code</label>
                                            <input type="text" class="form-control shadow-none" name="originZipCode" required>
                                        </div>

                                        <p class="text-primary text-uppercase fw-bold mb-3">where to?</p>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="destinationStreetAddress1" class="form-label">Street Address 1</label>
                                            <input type="text" class="form-control shadow-none" name="destinationStreetAddress1"
                                                required>
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="destinationStreetAddress2" class="form-label">Street Address 2</label>
                                            <input type="text" class="form-control shadow-none" name="destinationStreetAddress2">
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="destinationCity" class="form-label">City</label>
                                            <input type="text" class="form-control shadow-none" name="destinationCity" required>
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="destinationState" class="form-label">State</label>
                                            <input type="text" class="form-control shadow-none" name="destinationState" required>
                                        </div>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="destinationZipCode" class="form-label">Zip Code</label>
                                            <input type="text" class="form-control shadow-none" name="destinationZipCode" required>
                                        </div>

                                        <p class="text-primary text-uppercase fw-bold mb-3">Payment Method</p>

                                        <div class="form-group mb-4 pb-2">
                                            <label for="paymentMethod" class="form-label">Choose a Credit Card</label>
                                            <select class="form-control shadow-none" name="paymentMethod" required>
                                                <option></option>
                                                <?php for ($i = 0; $i < count($creditCards); $i++) { ?>
                                                    <option value="<?= $creditCards[$i]['ID'] ?>"><?= $creditCards[$i]['cardnumber'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
